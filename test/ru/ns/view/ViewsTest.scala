...
class ViewsTest extends PlaySpec
  ...
  "smr_index" should {
    "render" in {
      ...
      val device_1: DeviceView = DeviceView ("sdb2", "Acer", "1234567", "Acer 1", DateTime.parse("2010-06-30T01:20"), visible = true, 10)
      val device_2: DeviceView = DeviceView ("sdb3", "Bcer", "111-222", "Acer 2", DateTime.parse("-292275055-05-17T01:30:17.000+02:30:17"), visible = true, 1)

      val rowSeq = Vector[DeviceView](device_1, device_2, DeviceView("sdb1", "WD", "qwerty", "WD 4", DateTime.parse("2010-06-30T01:20"), true, 1))
